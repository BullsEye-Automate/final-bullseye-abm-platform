          ...
          <div key={n} className="flex items-center">
            <div className="flex flex-col items-center min-w-0">
              ...
              <span
                ...
                style={{
                  color: active ? "#251762" : done ? "#6b7280" : "#9ca3af",
            ...
            {i < STEP_LABELS.length - 1 && (
              <div
                className="h-0.5 mx-2 shrink-0"
                style={{
                  width: 32,
                  background: done ? "#62E0D8" : "#e5e7eb",
                  marginBottom: 20,
                }}
              />
            )}
  ...
  return (
    <div className="max-w-2xl">
      ...
      <div className="card">
        ...
        {error && (
          <p className="text-danger-fg text-sm mb-4 bg-danger-bg rounded-lg px-3 py-2">
            {error}
          </p>
        )}
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <div
                ...
                style={{
                  background: logoUrl ? "transparent" : "rgba(37,23,98,0.08)",
                  border: "1px dashed #c8c3dc",
                }}
              >
                {logoUrl ? (
          ...
          <div>
            ...
            {ownersLoading ? (
              <div className="flex items-center gap-2 text-ink-muted text-sm">
                ...
                Cargando usuarios de HubSpot...
              </div>
            ) : owners.length === 0 ? (
              <p className="text-sm text-ink-subtle">
                No se pudieron cargar los usuarios de HubSpot. Puedes continuar sin seleccionar.
              </p>
            ) : (
              <select
                className="input"

...
export async function POST(
  ...
  void logAiUsage({ userId, clientId: params.id, functionName: "client_clay_scoring_prompt", model: CLAUDE_MODEL, inputTokens: message.usage.input_tokens, outputTokens: message.usage.output_tokens });

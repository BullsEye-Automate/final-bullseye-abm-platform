...
const FULL_SELECT =
  "id, name, slug, logo_url, is_active, status, onboarding_step, onboarding_completed_at, description, hubspot_owner_id, clay_companies_webhook_url, clay_contacts_webhook_url, clay_scoring_prompt, created_at";

...
Smile Designers Lab,,,`}
      ...
      {nonSpecificCount > 0 && (
        <div className="card bg-warning-bg/40 border-warning-fg/20 flex items-start gap-3">
          <IconAlertCircle size={16} className="text-warning-fg shrink-0 mt-0.5" />
          <div className="text-xs text-ink-muted">
            {nonSpecificCount}{" "}
            {nonSpecificCount === 1 ? "empresa tiene" : "empresas tienen"} evidencia genérica
            o sin citas. Para re-verificarlas a mano, usa "Re-verificar con IA" en cada
            card.
          </div>
        </div>
      )}

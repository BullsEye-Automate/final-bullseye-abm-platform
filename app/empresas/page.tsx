...
export default function EmpresasPage() {
  ...
  // Precarga regiones, tamaños y modo ICP del cliente activo
  useEffect(() => {
        ...
        {discoveryMode === "recommend" && (
          <>
            <div className="space-y-3">
              {/* Selector de industria (solo en modo by_industry) */}
              {icpMode === "by_industry" && industries.length > 0 && (
                <div>
                  <p className="label block mb-2">Industria a buscar:</p>

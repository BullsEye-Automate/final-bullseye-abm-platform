...
- [ ] **Paso 2** — Ampliar la recolección de research pre-reunión en el backend (LinkedIn + señales, más allá de la búsqueda web básica del MVP original).
- [ ] **Paso 3** — UI del Módulo 1 (página de detalle con ese research). Nota: hoy `/reuniones/[id]` para una reunión futura sin analizar solo muestra "todavía no hay análisis" — falta construir ahí (o en una vista separada) el contenido real de investigación de empresa/prospecto.
- [ ] **Paso 4** — Agregar el puntaje 1-10 al prompt/esquema de análisis post-reunión (hoy la página de detalle ya muestra las sub-métricas 1-5 existentes, pero no hay un puntaje global 1-10).
- [x] ~~**Paso 5** — UI del Módulo 2 (página de detalle tipo DIIO con el análisis y el puntaje).~~ La página de detalle ya existe y muestra el análisis (falta solo el puntaje 1-10 del Paso 4, que se puede agregar a esta misma vista sin reconstruirla).

...
- LARGE / DSO (>100 employees) — CRITICAL filter for noise: Only senior buyer roles. VP, Director, Senior Manager, Chief, Head of + (Operations | Production | Clinical Services | Lab | CAD/CAM | Manufacturing | Digital). ALSO YES for "[Domain] Manager" titles where Domain is explicitly an operations area — Operations Manager, Production Manager, Lab Manager, Clinical Manager, CAD Manager, CAD/CAM Manager, Manufacturing Manager, Workflow Manager, Digital Workflow Manager — even without further qualification. Generic "Manager" or "Coordinator" alone, or "Manager + non-buyer area" (Marketing Manager, HR Manager, Training Manager, Talent Manager) → NO. A single-location Office Manager or Practice Manager at a 1000+ employee DSO is too operational → NO. Regional / District / Area Manager → YES only if the role clearly oversees dental operations (not marketing/HR regions).
